...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        '--is-scriptable',
        action='store_true',
        help='Verification to test if is compatible whith scripting, will return 0 and no text.')
    parser.add_argument(
            '-t',
            '--tweet',
            action='store_true',
            help='Tweets from the input in stdin')
    parser.add_argument(
        '-s',
        '--stream',
        default="mine",
